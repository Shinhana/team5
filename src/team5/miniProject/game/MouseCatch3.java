...
import team5.miniProject.game.MouseCatch2.Next;
import team5.miniProject.game.MouseCatch2.mousePanel;
import team5.miniProject.run.PanelChange;

public class MouseCatch3 extends JPanel {
	Image image;
	private PanelChange win;
	private JTextArea memoTextField;
	
	public MouseCatch3(PanelChange win){
		setLayout(null);
		this.win = win;
		
		image = new ImageIcon("images/jaemin-3.png").getImage();
...
//			}
	...
	class Next implements ActionListener{
		...
		public void actionPerformed(ActionEvent e){
			...
			if(str.contentEquals("1,4")||str.contentEquals("1 4")) {
				JOptionPane.showMessageDialog(null,"정답입니다.");
				win.change("mousecatch4");
			}else {
				JOptionPane.showMessageDialog(null,"틀렸습니다.");
				win.change("mousecatch3"); 
			}
