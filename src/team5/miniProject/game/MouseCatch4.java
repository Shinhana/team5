...
import team5.miniProject.game.MouseCatch3.Next;
import team5.miniProject.game.MouseCatch3.mousePanel;
import team5.miniProject.run.PanelChange;

public class MouseCatch4 extends JPanel {
	Image image;
	private PanelChange win;
	private JTextArea memoTextField;
	
	public MouseCatch4(PanelChange win){
		setLayout(null);
		this.win = win;
		
		image = new ImageIcon("images/jaemin-4.png").getImage();
