...
//----------------------------2.변수----------------------------
	...
	public Chap02Quiz2 variable_quiz2 = null; //퀴즈
  	...
  	public Chap02Test20Ans variable_test2Answer20 = null;//테스트답안
  	public Chap02Test21Ans variable_test2Answer21 = null;//테스트답안
...
//---------------------------6.중첩반복문 이차원배열--------------------
	...
	public Chap06Quiz1 nloop_quiz1 =null;
  	public Chap06AnsX nloop_quiz1Answer1 =null;
  	public Chap06AnsO nloop_quiz1Answer2 =null;
  	public Chap06Quiz2 darray_quiz2 =null;
  	public Chap06Ans1 darray_quiz2Answer1 =null;
  	public Chap06Ans2 darray_quiz2Answer2 =null;
  	public Chap06Choice test_choice =null;
  	public Chap06Test1 nloop_test1 =null;
  	public Chap06Test1Ans1 nloop_test1Answer1 =null;
  	public Chap06Test1Ans2 nloop_test1Answer2 =null;
...
//----------------------2배열-----------------------------------------
 	 	if(panelName.equals("variable_part1")){
 			...
 			revalidate();
 			repaint();
 		}else if(panelName.equals("variable_main")){
 			getContentPane().removeAll();
 			getContentPane().add(variable_main);
 			revalidate();
 			repaint();
 		}  
 			...
 			revalidate();
 			repaint();
 		} else if(panelName.equals("variable_test2Answer20")){
 			getContentPane().removeAll();
 			getContentPane().add(variable_test2Answer20);
 			revalidate();
 			repaint();
 		} else if(panelName.equals("variable_test2Answer21")){
 			getContentPane().removeAll();
 			getContentPane().add(variable_test2Answer21);
 			revalidate();
 			repaint();
 }
...
//---------------------------------------4.제어문---------------------------------------------
  			...
  			revalidate();
  			repaint();
  		}else if(panelName.equals("control_quizAnswer1")){
  			getContentPane().removeAll();
  			getContentPane().add(control_quizAnswer1);
  			revalidate();
  			repaint();
...
//---------------------------------------6.중첩반복문-------------------------------------------------------------------------------
  	...
  	}else if(panelName.equals("nloop_quiz1")){
 			getContentPane().removeAll();
 			getContentPane().add(nloop_quiz1);
 			revalidate();
 			repaint();
 		}else if(panelName.equals("nloop_quiz1Answer1")){
 			getContentPane().removeAll();
 			getContentPane().add(nloop_quiz1Answer1);
 			revalidate();
 			repaint();
 		}else if(panelName.equals("nloop_quiz1Answer2")){
 			getContentPane().removeAll();
 			getContentPane().add(nloop_quiz1Answer2);
 			revalidate();
 			repaint();
 		}else if(panelName.equals("darray_quiz2")){
 			getContentPane().removeAll();
 			getContentPane().add(darray_quiz2);
 			revalidate();
 			repaint();
 		}else if(panelName.equals("darray_quiz2Answer1")){
 			getContentPane().removeAll();
 			getContentPane().add(darray_quiz2Answer1);
 			revalidate();
 			repaint();
 		}else if(panelName.equals("darray_quiz2Answer2")){
 			getContentPane().removeAll();
 			getContentPane().add(darray_quiz2Answer2);
 			revalidate();
 			repaint();
 		}else if(panelName.equals("test_choice")){
 			getContentPane().removeAll();
 			getContentPane().add(test_choice);
 			revalidate();
 			repaint();
 		}else if(panelName.equals("nloop_test1")){
 			getContentPane().removeAll();
 			getContentPane().add(nloop_test1);
 			revalidate();
 			repaint();
 		}else if(panelName.equals("nloop_test1Answer1")){
 			getContentPane().removeAll();
 			getContentPane().add(nloop_test1Answer1);
 			revalidate();
 			repaint();
 		}else if(panelName.equals("nloop_test1Answer2")){
 			getContentPane().removeAll();
 			getContentPane().add(nloop_test1Answer2);
 			revalidate();
 			repaint();
 	}else if(panelName.equals("darray_test2")){
 		getContentPane().removeAll();
 		getContentPane().add(darray_test2);
 		revalidate();
 		repaint();
 	}else if(panelName.equals("darray_test2Answer1")){
 		getContentPane().removeAll();
 		getContentPane().add(darray_test2Answer1);
 		revalidate();
 		repaint();
 	}else if(panelName.equals("darray_test2Answer2")){
 		getContentPane().removeAll();
