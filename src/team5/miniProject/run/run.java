...
//------------------------2.변수(미완)--------------------------------------
 		...
 		win.variable_part2 = new Chap02VariablePart2(win);
    	win.variable_part3 = new Chap02VariablePart3(win);
    	win.variable_part4 = new Chap02VariablePart4(win);
    	win.variable_part5 = new Chap02VariablePart5(win);
    	...
    	win.variable_test2Answer20 = new Chap02Test20Ans (win);
    	win.variable_test2Answer21 = new Chap02Test21Ans (win);
...
//---------------------------4.제어문-----------------------------------
   	win.control_main = new Chap04ControlStatement(win);
   	win.branch_part1 = new Chap04BranchPart1(win);
   	win.conditional_part1 = new Chap04ConditionalPart1(win);
   	win.conditional_part2 = new Chap04ConditionalPart2(win);
   	win.loop_part1 = new Chap04LoopPart1(win);
   	win.loop_part2 = new Chap04LoopPart2(win);
   	win.control_quiz = new Chap04QuizTime(win);
   	win.control_quiz1 = new Chap04Quiz1(win);
   	win.control_quiz2 = new Chap04Quiz2(win);
   	win.control_test1 = new Chap04Test1(win);
   	win.control_test2 = new Chap04Test2(win);
   	win.control_quizAnswer1 = new Chap04Quiz1Ans(win);
   	win.control_test1Answer1 = new Chap04Test1Ans1(win);
   	win.control_test1Answer2 = new Chap04Test1Ans2(win);
...
//------------------------5.배열(미완)-----------------------------------
   	...
   	win.array_part5 = new  Chap05ArrayPart5(win);
   	win.array_part6 = new  Chap05ArrayPart6(win);
   	win.array_quiz1 = new  Chap05Quiz1(win);
   	win.array_quiz2 = new  Chap05Quiz2(win);
   	win.array_quiz1AnsO = new  Chap05Quiz1AnsO(win);
   	win.array_quiz1AnsX = new  Chap05Quiz1AnsX(win);
   	win.array_quiz2AnsO = new  Chap05Quiz2AnsO(win);
   	win.array_quiz2AnsX = new  Chap05Quiz2AnsX(win);
   	win.array_test1 = new  Chap05Test1(win);
   	win.array_test2 = new  Chap05Test2(win);
   	win.array_test1Ans1 = new  Chap05Test1Ans1(win);
   	win.array_test2Ans1 = new  Chap05Test2Ans1(win);
	...
	win.nloop_quiz1 = new Chap06Quiz1(win);
	win.nloop_quiz1Answer1 = new Chap06AnsX(win);
	win.nloop_quiz1Answer2 = new Chap06AnsO(win);
	win.darray_quiz2 = new Chap06Quiz2(win);
	win.darray_quiz2Answer1 = new Chap06Ans1(win);
	win.darray_quiz2Answer2 = new Chap06Ans2(win);
	win.test_choice = new Chap06Choice(win);
	win.nloop_test1 = new Chap06Test1(win);
	win.nloop_test1Answer1 = new Chap06Test1Ans1(win);
	win.nloop_test1Answer2 = new Chap06Test1Ans2(win);
	win.darray_test2 = new Chap06Test2(win);
	win.darray_test2Answer1 = new Chap06Test2Ans1(win);
	...
	win.speedquiz1 = new SpeedQuiz1(win);
	win.speedquiz2 = new SpeedQuiz2(win);
	win.speedquiz3 = new SpeedQuiz3(win);
	win.speedquiz4 = new SpeedQuiz4(win);
	win.speedquiz5 = new SpeedQuiz5(win);
	win.speedquiz6 = new SpeedQuiz6(win);
	win.speedquiz7 = new SpeedQuiz7(win);
